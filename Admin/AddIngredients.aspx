<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddIngredients.aspx.cs" Inherits="bp2.Admin.EditRecipe" %>
    ...
    <div class="padded-box">
        ...
        <asp:Panel ID="pnlSelect" runat="server">
            ...
            <asp:Repeater ID="rptRecipe" runat="server">
                ...
                <ItemTemplate>
                    <li>
                        <a href="AddIngredients.aspx?RecipeID=<%#Eval("RecipeID") %>">
                            <h4>
                                <%#Eval("Name") %>
                            </h4>
                        </a>
        ...
        <asp:Panel ID="pnlForm" Visible="false" runat="server">
            ...
            <div class="form-horizontal">
                ...
                <asp:Button Text="Add Ingredients" OnClick="AddIngredients" CssClass="btn btn-default" runat="server" />
